...
- **Process Sales** — Handles customer purchases with quantity validation and automatic discount application
- **Automatic Discounts** — Applies a 5% discount on purchases exceeding 300 BWP
